...
sed -i.bck -E "s|containerImage:(.*)kube-green/kube-green:[0-9]+.[0-9]+.[0-9]+.*|containerImage:\1kube-green/kube-green:${TAG_VALUE_WITHOUT_V}|" "${SOURCE_DIR}/config/manifests/bases/kube-green.clusterserviceversion.yaml"
