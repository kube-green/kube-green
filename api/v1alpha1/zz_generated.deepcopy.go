...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ParsedExceptionSchedule) DeepCopyInto(out *ParsedExceptionSchedule) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ParsedExceptionSchedule.
func (in *ParsedExceptionSchedule) DeepCopy() *ParsedExceptionSchedule {
	if in == nil {
		return nil
	}
	out := new(ParsedExceptionSchedule)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SleepInfoSpec) DeepCopyInto(out *SleepInfoSpec) {
	*out = *in
	...
	if in.ScheduleException != nil {
		in, out := &in.ScheduleException, &out.ScheduleException
