...
func (v *customValidator) ValidateUpdate(ctx context.Context, _, s *v1alpha1.SleepInfo) (admission.Warnings, error) {
...
func (v *customValidator) ValidateDelete(ctx context.Context, s *v1alpha1.SleepInfo) (admission.Warnings, error) {
