...
func (r *SleepInfoReconciler) handleSleep(logger logr.Logger, ctx context.Context, resources Resources) error {
	...
	err := s.updateDeploymentsWithZeroReplicas(ctx, resources.Deployments)
	if err != nil {
...
func (s *sleep) updateDeploymentsWithZeroReplicas(ctx context.Context, deployments []appsv1.Deployment) error {
